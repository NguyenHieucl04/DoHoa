...
function main() {
  ...
  matran.setTranslate(0.5 * Math.cos(3.14/6.0), 0.5 * Math.sin(3.14/6.0), 0.0);
  matran.rotate(goc, 0, 0, 1);
  matran.translate(-0.5 * Math.cos(3.14/6.0), -0.5 * Math.sin(3.14/6.0), 0.0);
